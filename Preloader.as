package 
{
	...
	{
		[Embed(source="assets/images/preloader/logo.png")] protected var ImgLogo:Class;
		[Embed(source="assets/images/preloader/logo_corners.png")] protected var ImgLogoCorners:Class;
		[Embed(source="assets/images/preloader/logo_light.png")] protected var ImgLogoLight:Class;
		 ...
		 */
		public var className:String = "Main";
		/**
      ...
      _min = minDisplayTime*1000;
		...
		protected function update(Percent:Number):void
		{
			...
			_text.text = String(Math.floor(Percent*100))+"%";
